...
const Profile = (props) => {
  ...
  <Dropdown.Menu>
    {
      folders.map((folder,index )=><Dropdown.Item key={index} href="#/action-1" onClick={()=>addprofiletofolder(folder._id)}>{folder.folderName}</Dropdown.Item>)
    }
              ...
              <div className="tab-content profile-tab" id="myTabContent">
                ...
                >
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <p>
                        {profile.experiences.education.map((value) => (
                          <span>
                            {" "}
                  ...
                  <div className="row">
                    ...
                    <br/>
                      <p>
                        {profile.experiences.jobs.map((value) => (
